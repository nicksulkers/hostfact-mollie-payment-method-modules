...
class mollie_paypal extends mollie
{
    ...
    {
        return array(
            'InternalName' => 'Mollie PayPal',
            'MerchantID' => array(
                'Title' => "Mollie API key",
                'Value' => ""
            ),
            'Advanced' => array(
                'Title' => "Betaling via PayPal",
                'Image' => "paypal.jpg",
                'Description' => "Met Mollie PayPal kunt u vertrouwd, veilig en gemakkelijk uw online betalingen verrichten.",
                'FeeType' => "",
                'FeeAmount' => "0",
    ...
    {
        $_SESSION['mollie_payment_method'] = 'paypal';
